namespace ViewModels
{
    internal class FileOperationsViewModel
    {
        public static object SetFileNames(WinchModel winch)
        {
            ...
            winch.MtnwWireLogName = $"{ dateAndHour }_{ _confDataStore.CruiseNameBox }_cast_{ globalConfig.CruiseInformation.CastNumber }_{winch.WinchName}_short.log";
            winch.UnolsWireLogName = $"{ dateAndHour }_{ _confDataStore.CruiseNameBox }_cast_{ globalConfig.CruiseInformation.CastNumber }_{winch.WinchName}_UNOLS.log";
