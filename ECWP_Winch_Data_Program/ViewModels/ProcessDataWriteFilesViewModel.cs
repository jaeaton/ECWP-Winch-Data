...
{
    internal class ProcessDataWriteFilesViewModel
    {
        ...
        //{
        //    //ExcelViewModel.AddData(MainViewModel._configDataStore.CurrentWinch, maxTensionString, maxTensionString, MainViewModel._configDataStore);
        //    using (System.IO.StreamWriter file = new System.IO.StreamWriter(ProcessDataViewModel.ParseData.Directory + '\\' + ProcessDataViewModel.ParseData.ProcessedFileName, true))    //Write Processed Log file
        //    {
