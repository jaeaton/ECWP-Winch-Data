namespace Models
{
    public class GlobalConfigModel : ObservableObject
    {
        ...
        public List<WinchModel> Winches { get; set; } = new();
        public string Minimal20HzLogFileName { get; set; } = string.Empty;
        public string MaxLogFileName { get; set; } = string.Empty;
        public string UnolsWireLogName { get; set; } = string.Empty;
        public string UnolsWinchLogName { get; set; } = string.Empty;
        ...
        public string SerialPortBaud { get; set; } = string.Empty;
        public bool SerialSwitch { get; set; } = new bool();
        public bool UnolsSerialFormatSet { get; set; } = new bool();
        public string WinchSelection { get; set; } = string.Empty;
